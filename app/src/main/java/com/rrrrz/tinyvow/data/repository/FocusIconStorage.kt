...
class FocusIconStorage(
    ...
    fun importImage(
        ...
        contentResolver.openInputStream(sourceUri).use { input ->
            requireNotNull(input) { "Unable to open focus icon source." }
    ...
    companion object {
        fun fromContext(context: Context): FocusIconStorage = FocusIconStorage(File(context.filesDir, DIRECTORY_NAME))

        private const val DIRECTORY_NAME = "focus_icons"
    }
}
